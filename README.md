...
Профессиональный лендинг для Kandai Systems — экосистема автоматизации для маркетплейсов и бизнеса.

## 🚀 Технологии

- **Astro** — современный фреймворк для статических сайтов
- **Tailwind CSS** — утилитарный CSS фреймворк
- **Decap CMS** — админ-панель для управления контентом
...
`https://cablemanpunk.github.io/kandai/`

## 🎯 Админ-панель

Для управления контентом используйте Decap CMS по адресу:
`https://cablemanpunk.github.io/kandai/admin/`

### Настройка аутентификации

1. В настройках GitHub репозитория включите "GitHub Pages"
2. Настройте OAuth приложение для Decap CMS
3. Добавьте необходимые secrets в репозиторий
